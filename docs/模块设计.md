# Vibe-Flow 模块设计（对标 Unusual Whales · 全量）

> 2026-07-26 建。**工作名 Vibe-Flow，最终名待 Simon 拍板。**
...
| `congress.py` | House Clerk + Senate eFD | **S** | 议员交易披露 |
...
| 5 | **Congress 国会** | 议员交易、延迟披露、组合 | House/Senate |
| 6 | **Insiders 内部人** | Form 4 流、买卖分级、板块流向 | EDGAR |
| 7 | **Institutions 机构** | 13F 持仓、变动、画像 | EDGAR |
| 8 | **Shorts 做空** | 全市场空头量、FTD、趋势 | FINRA |
